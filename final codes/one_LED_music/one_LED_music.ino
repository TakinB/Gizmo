...
#define LED_PIN 8 // change this to pin number 8
...
void visualize_music() {
  ...
  if (sensor_value == 0){
   Serial.print("************ No microphone input *************");
    return;
  }
  ...
  int servo_mapped = map(sensor_value,0,512,0,180);
...
//    Color.b = -1;
   ...
   pixels.setPixelColor(0, pixels.Color(0,110,10)); // Moderately bright green color.
   pixels.show(); // This sends the updated pixel color to the hardware.
   myservo.write(sensor_value); 
   Serial.print("High");
...
//    Color.b = 2;
//    Color.g = 1;
  pixels.setPixelColor(0, pixels.Color(1,1,1)); // Moderately bright green color.
  pixels.show(); // This sends the updated pixel color tod the hardware.
  myservo.write(sensor_value); 
  Serial.print("Normal");
